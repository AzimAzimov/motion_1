...
const Nav = () => {
  ...
  return (
    ...
    >
      <div className="flex xl:flex-col w-full xl-flex-col items-center justify-between
      ...
      >
        {navData.map((item, index) => {
          return (
            <Link
              className={`${item.path === pathName && 'text-accent'} relative
              ...
              <div className="absolute hidden pr-14 right-0 xl:group-hover:flex">
                <div className="bg-white relative text-primary items-center p-[6px] rounded-[3px]">
                  ...
                  <div className="border-solid border-l-white border-l-8 border-y-transparent
                    border-y-[6px] border-r-0 absolute -right-2 top-[30%]"
                  />
                </div>
              </div>
              {/*icons*/}
