...
const About = () => {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col gap-x-6 items-center xl:flex-row">
        {/*text*/}
        <div className="flex flex-1 flex-col justify-center">
          ...
          <motion.div
            ...
            animate={"show"}
            exit={"hidden"}
            className="my-0 lg:my-5 hidden xl:flex"
          >
            <div className="flex flex-1 xl:gap-x-6">
              {/*work*/}
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10
                after:absolute after:top-0 after:right-5 mb-3">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
                  <CountUp start={0} end={10} duration={5}/> +
                </div>
                <div className="text-xs uppercase tracking-[1px] leading-[1.4] m-auto max-w-[100px] xl:m-0">
                  Years of experience
                </div>
              </div>
              {/*clients*/}
              <div
                ...
                after:absolute after:top-0 after:right-4 mb-3">
                <div className="text-2xl xl:text-4xl font-extrabold text-accent mb-2">
        ...
        {/*info*/}
        <div
          className="flex flex-col w-full xl:max-w-[48%] h-[390px]">
          <motion.div
            ...
            {aboutData.map((item, itemIndex) => {
              return (
                <div
                  ...
                  cursor-pointer capitalize xl:text-lg relative after:w-8 after:left-0
          ...
          <motion.div
            ...
            animate={"show"}
            exit={"hidden"}
            className="py-2 xl:py-6 flex-col flex gap-y-4 xl:gap-y-4
